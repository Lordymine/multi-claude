...
export const en: TranslationDictionary = {
	...
	editFlow: {
		...
		urlLabel: "Server URL (enter new value)",
	...
	settings: {
		...
		masterPasswordSet: "Master password set. You will be prompted on each launch.",
		masterPasswordRemoved: "Master password removed. Using file-based encryption.",
		masterPasswordLabel: "New master password",
		masterPasswordConfirmLabel: "Confirm master password",
		masterPasswordCurrentLabel: "Current master password",
	...
	statusLine: {
		title: "Status Line",
		selectTemplate: "Select a status line template",
		none: "Disabled",
	...
	launchOptions: {
		...
		descSkipPermissions: "Skip all permission prompts (use with caution)",
		descWorktree: "Run in an isolated git worktree",
		descLoadDotenv: "Read .env from the current directory and inject variables into Claude Code",
